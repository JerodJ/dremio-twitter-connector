...
@SourceType(value = "TwitterARP", label = "Twitter",uiConfig = "twitter-layout.json")
public class TwitterConf extends AbstractArpConf<TwitterConf> {
  private static final String ARP_FILENAME = "arp/implementation/twitter-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.twitter.TwitterDriver";
